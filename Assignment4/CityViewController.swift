...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
    ...
    detailVC.countryName.text = self.city.country
    detailVC.cityName.text = self.city.name
    detailVC.tempName.text = String(self.city.temp)
    detailVC.summeryName.text = self.city.summary
    detailVC.countryFlag.text = self.city.flag
